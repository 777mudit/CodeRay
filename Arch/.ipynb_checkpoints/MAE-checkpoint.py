import torch
import timm
from timm.models.layers import trunk_utils
...
dataset = UnlabeledXrayDataset("/path/to/your/unlabeled/data", transform=transform)
...
for epoch in range(EPOCHS):
    ...
    for batch in loader:
        ...
        # Forward pass: model masks the image internally and tries to reconstruct it
